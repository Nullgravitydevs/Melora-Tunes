                        ...
                        {mixes.map((mix, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute -top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 group-hover:-translate-y-1 transition-all duration-300 ease-out" onPointerDown={(e) => e.stopPropagation()}>
                                        <button
                    ...
                    >
                        ...
                        <div className="bg-[#1e1e1e] w-full aspect-[16/9] rounded-lg shadow-[inset_2px_2px_6px_rgba(0,0,0,0.6)] relative mb-4 border-b-2 border-gray-700 flex items-center justify-center overflow-hidden">
                            ...
                            {hasCassette && activeMix ? (
                                <div
                                    className="w-[70%] aspect-[3/2] rounded-md shadow-lg border-t border-l border-white/20 border-b border-r border-black/30 p-1.5 flex flex-col justify-between relative z-10"
                                    style={{
